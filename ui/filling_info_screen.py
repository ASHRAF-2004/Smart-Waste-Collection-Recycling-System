...
class FillingInfoScreen(BaseScreen):
    ...
    def __init__(self, master, app, **kwargs):
        ...
        self.add_top_bar(back_command=lambda: self.app.show_screen("Registration"))
        ...
        self.zone_combo.grid(row=zone_row + 1, column=0, columnspan=2, sticky="ew", pady=(6, 2))
        ...
        self.zone_err.grid(row=zone_row + 2, column=0, columnspan=2, sticky="w", pady=(0, 8))

        self.create_btn = tk.Button(self.form, bd=0, width=26, pady=10, command=self._create_account)
        self.create_btn.grid(row=zone_row + 3, column=0, columnspan=2, pady=8)
